...
$sql = "SELECT * FROM db_customer" ;		//Query to be executed
...
echo '<div style = "margin-bottom: -30px;background-color: #252541;color: white;">Customer Table</div>';	//Style content from table
echo '<table>
