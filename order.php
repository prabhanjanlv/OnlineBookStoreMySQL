...
$sql = "SELECT * FROM db_order" ;		//Query to be executed
...
echo '<div style = "margin-bottom: -30px;background-color: #252541;color: white;">Order Table</div>';	//Style content from table
echo '<table>
...
if (!mysqli_query($conn,$result1))
  {
	echo'<div style = "float: right;margin-top:-555px;">';
