...
$sql = "SELECT * FROM db_supplier" ;		//Query to be executed
...
echo '<div style = "margin-bottom: -30px;background-color: #252541;color: white;">Supplier Table</div>';	//Style content from table
echo '<table>
