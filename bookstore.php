...
$sql = "SELECT * FROM db_book" ;		//Query to be executed
$result = $conn->query($sql);		//Result from the connected Database
$all_property = array();  //declare an array for saving property

//showing property

echo '<div style="float: left;margin-left: -430px;margin-top: 100px;">';				//Print tables from result
echo '<div style = "margin-bottom: -30px;background-color: #252541;color: white;">Book Table</div>';	//Style content from table
echo '<table>
...
if (!mysqli_query($conn,$result1))
  {
	echo'<div style = "float: right;margin-top:-586px;">';
...
//showing property
echo '<div style="float: right; margin-right: -430px; margin-top: 100px;">';		//Styling for the table
